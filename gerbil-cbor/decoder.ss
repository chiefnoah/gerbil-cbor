...
(def (extract-raw-arg arg)
  (using (arg :~ fixnum?)
    ; chop off the upper 3 bits
    (fxand 31 arg)))
...
(def (default-decoder buffer)
     (using (buffer :- BufferedReader)
            (let (item (buffer.read-u8!))
              (let (decode-method (vector-ref +unmarshal+ j))
                ; TODO: see if we can avoid apply here, but probably not
                (apply decode-method buffer)
                (if (eq? buffer.peek-u8 #!eof)
                  item)))))

(def (malformed-message _)
...
(begin
  ...
  (register 0 24 BufferedReader-read-u8)
  (register 0 25 BufferedReader-read-u16)
  (register 0 26 BufferedReader-read-u32)
  (register 0 27 BufferedReader-read-u64)
  (register-range 0 28 31 malformed-message)
  ; negative integers
  (register-range 1 0 23 extract-raw-arg)
  (register 1 24 BufferedReader-read-u8)
  (register 1 25 BufferedReader-read-u16)
  (register 1 26 BufferedReader-read-u32)
  (register 1 27 BufferedReader-read-u64)
  (register-range 1 28 31 malformed-message)
  ; byte strings
  ; TODO: implement extracting byte slice from here instead of just BufferedReader-reading arg
  (register-range 2 0 23 extract-raw-arg)
  (register 2 24 BufferedReader-read-u8)
  (register 2 25 BufferedReader-read-u16)
  (register 2 26 BufferedReader-read-u32)
  (register 2 27 BufferedReader-read-u64)
  ...
  (register 3 24 BufferedReader-read-u8)
  (register 3 25 BufferedReader-read-u16)
  (register 3 26 BufferedReader-read-u32)
  (register 3 27 BufferedReader-read-u64)
  ; TODO: this actually should indicate an indefinite length message
  (register-range 3 28 31 malformed-message)
  ; array
  ; TODO: implement handling of array members
  (register-range 4 0 23 extract-raw-arg)
  (register 4 24 BufferedReader-read-u8)
  (register 4 25 BufferedReader-read-u16)
  (register 4 26 BufferedReader-read-u32)
  (register 4 27 BufferedReader-read-u64)
  ; TODO: this actually should indicate an indefinite length message
  (register-range 4 28 31 malformed-message)
  ; map
  ; TODO: implement handling of mapping members
  (register-range 5 0 23 extract-raw-arg)
  (register 5 24 BufferedReader-read-u8)
  (register 5 25 BufferedReader-read-u16)
  (register 5 26 BufferedReader-read-u32)
  (register 5 27 BufferedReader-read-u64)
  ; TODO: this actually should indicate an indefinite length message
  (register-range 5 28 31 malformed-message)
  ; tagged data items
  ; TODO: handle tags
  (register-range 6 0 23 extract-raw-arg)
  (register 6 24 BufferedReader-read-u8)
  (register 6 25 BufferedReader-read-u16)
  (register 6 26 BufferedReader-read-u32)
  (register 6 27 BufferedReader-read-u64)
  ...
  (register 7 24 BufferedReader-read-u8)
  (register 7 25 BufferedReader-read-u16)
  (register 7 26 BufferedReader-read-u32)
  (register 7 27 BufferedReader-read-u64)
